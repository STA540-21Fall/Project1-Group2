...
income_unemp = read_excel("data/Income_Unemployment.xlsx", skip = 4)[,c(1,88,89,90,91)]
...
names(income_unemp) = c("fips","employed","unemployed","unemployed.rate","median.income")
income_unemp$year = rep("2020", nrow(income_unemp))
income = income_unemp[,c(1,5)]
unemp2020 = income_unemp[,c(1:4,6)]
